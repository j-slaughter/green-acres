    ...
    <main className="flex min-h-screen flex-col p-6 bg-amber-50">
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          ...
          >
            <strong>Welcome to Green Acres.</strong> This is the example for the{' '}
        ...
        <div className="flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12">
          ...
          <Image
            ...
            alt="Generated images of the dashboard project showing desktop version"
          />
          <Image
            src="/hero-mobile.png"
            width={1024}
            ...
            alt="Generated images of the dashboard project showing mobile version"
          />
        </div>
      </div>
    </main>
